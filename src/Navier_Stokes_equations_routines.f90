...
!
  ...
  SUBROUTINE NAVIER_STOKES_EQUATIONS_SET_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    INTEGER(INTG) :: equationsSetFieldNumberOfComponentsVar2
      ...
      CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE, &
        ...
        CASE(EQUATIONS_SET_SETUP_INITIAL_TYPE)
          ...
          CASE (EQUATIONS_SET_TRANSIENT_SUPG_NAVIER_STOKES_SUBTYPE, &
            ...
            CASE(EQUATIONS_SET_SETUP_START_ACTION)
              ...
              ELSE IF (EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE) THEN
                EQUATIONS_SET_FIELD_NUMBER_OF_COMPONENTS = 13  
                equationsSetFieldNumberOfComponentsVar2 = 1
                ! SUPG parameters and shear rate variable
                ...
                CALL FIELD_TYPE_SET_AND_LOCK(EQUATIONS_SET_FIELD_FIELD,FIELD_GENERAL_TYPE,&
                 ...
                 IF (EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE) THEN
                   ...
                   CALL FIELD_VARIABLE_LABEL_SET(EQUATIONS_SET_FIELD_FIELD,FIELD_V_VARIABLE_TYPE, &
                     & "ShearRate",ERR,ERROR,*999)
                   CALL FIELD_DATA_TYPE_SET_AND_LOCK(EQUATIONS_SET_FIELD_FIELD,FIELD_V_VARIABLE_TYPE, &
                     & FIELD_DP_TYPE,ERR,ERROR,*999)
                   CALL FIELD_NUMBER_OF_COMPONENTS_SET_AND_LOCK(EQUATIONS_SET_FIELD_FIELD,&
                     & FIELD_V_VARIABLE_TYPE,equationsSetFieldNumberOfComponentsVar2,ERR,ERROR,*999)
                 ELSE
                   CALL FIELD_VARIABLE_TYPES_SET_AND_LOCK(EQUATIONS_SET_FIELD_FIELD,&
                     & [FIELD_U_VARIABLE_TYPE],ERR,ERROR,*999)
                   CALL FIELD_VARIABLE_LABEL_SET(EQUATIONS_SET_FIELD_FIELD,FIELD_U_VARIABLE_TYPE, &
            ...
            CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
              IF(EQUATIONS_SET%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_AUTO_CREATED) THEN
                ...
                IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_TRANSIENT_SUPG_NAVIER_STOKES_MULTIDOMAIN_SUBTYPE) THEN
                  ...
                  EQUATIONS_SET_FIELD_NUMBER_OF_COMPONENTS = 13
                ELSE IF (EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE) THEN
                  ! SUPG and multidomain components
                  EQUATIONS_SET_FIELD_NUMBER_OF_COMPONENTS = 13  
                  ! Shear Rate Variable
                  equationsSetFieldNumberOfComponentsVar2 = 1
                  CALL FIELD_COMPONENT_VALUES_INITIALISE(EQUATIONS_SET%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
        ...
        CASE(EQUATIONS_SET_SETUP_GEOMETRY_TYPE)
          ...
          CASE (EQUATIONS_SET_TRANSIENT_SUPG_NAVIER_STOKES_SUBTYPE, &
            ...
            SELECT CASE(EQUATIONS_SET_SETUP%ACTION_TYPE)
            CASE(EQUATIONS_SET_SETUP_START_ACTION)
              IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_TRANSIENT_SUPG_NAVIER_STOKES_MULTIDOMAIN_SUBTYPE .OR. &
              ...
              IF(EQUATIONS_EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_AUTO_CREATED) THEN
                ...
                ELSE IF (EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE) THEN
                  ...
                  CALL FIELD_COMPONENT_INTERPOLATION_SET_AND_LOCK(EQUATIONS_SET%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
                    & FIELD_U_VARIABLE_TYPE,EQUATIONS_SET_FIELD_NUMBER_OF_COMPONENTS,FIELD_NODE_BASED_INTERPOLATION,ERR,ERROR,*999)
                  ! Gauss-point based field for ShearRate
                  CALL FIELD_COMPONENT_MESH_COMPONENT_SET_AND_LOCK(EQUATIONS_SET%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
                    & FIELD_V_VARIABLE_TYPE,1,GEOMETRIC_COMPONENT_NUMBER,ERR,ERROR,*999)
                  CALL FIELD_COMPONENT_INTERPOLATION_SET_AND_LOCK(EQUATIONS_SET%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
                    & FIELD_V_VARIABLE_TYPE,1,FIELD_GAUSS_POINT_BASED_INTERPOLATION,ERR,ERROR,*999)
                ELSE
                  DO component_idx = 1, EQUATIONS_SET_FIELD_NUMBER_OF_COMPONENTS
                    CALL FIELD_COMPONENT_MESH_COMPONENT_SET_AND_LOCK(EQUATIONS_SET%EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_FIELD, &
                      & FIELD_U_VARIABLE_TYPE,component_idx,GEOMETRIC_COMPONENT_NUMBER,ERR,ERROR,*999)
...
!                ENDIF
                ...
                ! IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE) THEN
                !   CALL FIELD_VARIABLE_LABEL_SET(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD,FIELD_U1_VARIABLE_TYPE, &
                !    & "shearRate",ERR,ERROR,*999)
...
!                ENDIF
                ...
                CASE(EQUATIONS_SET_FEM_SOLUTION_METHOD)
                  ...
                  ENDDO !component_idx
                  ! IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE) THEN
                  !   CALL FIELD_COMPONENT_INTERPOLATION_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_U1_VARIABLE_TYPE, &
                  !     & 1,FIELD_GAUSS_POINT_BASED_INTERPOLATION,ERR,ERROR,*999)
                  ! ENDIF
                CASE(EQUATIONS_SET_BEM_SOLUTION_METHOD)
                  CALL FLAG_ERROR("Not implemented.",ERR,ERROR,*999)
                CASE(EQUATIONS_SET_FD_SOLUTION_METHOD)
                    ...
                    IF(ASSOCIATED(EQUATIONS_MATERIALS)) THEN
                      IF(EQUATIONS_MATERIALS%MATERIALS_FINISHED) THEN
                        ...
                        IF(ASSOCIATED(GEOMETRIC_FIELD)) THEN
                          ...
                          CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_PowerLaw)
                            !Set analtyic function type
                            EQUATIONS_SET%ANALYTIC%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_PowerLaw
                          ...
                          CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_Sinusoid)
                            !Set analtyic function type
                            EQUATIONS_SET%ANALYTIC%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_Sinusoid
                            !Check that domain is 3D
                            IF(NUMBER_OF_DIMENSIONS/=3) THEN
                              LOCAL_ERROR="The number of geometric dimensions of "// &
                                & TRIM(NUMBER_TO_VSTRING(NUMBER_OF_DIMENSIONS,"*",ERR,ERROR))// &
              ...
              IF(ASSOCIATED(EQUATIONS_MATERIALS)) THEN
                IF(EQUATIONS_MATERIALS%MATERIALS_FIELD_AUTO_CREATED) THEN
                  ...
                  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                    & 1,GEOMETRIC_COMPONENT_NUMBER,ERR,ERROR,*999)
                  IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE) THEN
                    ! Constitutive Law for viscosity- define at gauss points (to be set by CellML)
        ...
        IF(ASSOCIATED(CONTROL_LOOP%PROBLEM)) THEN
          ...
          CASE(PROBLEM_Constitutive_NAVIER_STOKES_SUBTYPE)
            ...
            ELSE
              CALL FLAG_ERROR("Solver equations is not associated.",ERR,ERROR,*999)
            ENDIF
            ! If analytic field associated, calculate analytic profile
            ...
            IF(ASSOCIATED(equationsSet)) THEN
              IF(ASSOCIATED(equationsSet%ANALYTIC)) THEN
                ...
                IF(ASSOCIATED(boundaryConditions)) THEN
                  CALL NavierStokes_AnalyticCalculate(equationsSet,boundaryConditions,ERR,ERROR,*999)
                ENDIF
              ENDIF
            ELSE
              CALL FLAG_ERROR("Equations set is not associated.",ERR,ERROR,*999)
          ...
          CASE(PROBLEM_Coupled3D1D_NAVIER_STOKES_SUBTYPE)
            CALL CONTROL_LOOP_CURRENT_TIMES_GET(CONTROL_LOOP,currentTime,timeIncrement,ERR,ERROR,*999)
            !--- Solver numbering based on control subloop structure
            ! subloop 1 = 3D NSE solver, subloop 2 = Characteristic, 1D NSE solver
            ...
            CASE(2) 
              ...
              ELSE
                CALL FLAG_ERROR("Solver equations is not associated.",ERR,ERROR,*999)
              ENDIF
              SELECT CASE(SOLVER_EQUATIONS%SOLVER%GLOBAL_NUMBER)
              CASE(1)
                CALL NavierStokes_UpdateCharacteristics(solverEquations,timeIncrement,ERR,ERROR,*999)
              CASE(2)
                !--- Set explicitly 'SOLVER_MATRIX%UPDATE_MATRIX=.TRUE.'for 1D NSE
                SOLVER_MATRICES=>SOLVER_EQUATIONS%SOLVER_MATRICES
                IF(ASSOCIATED(SOLVER_MATRICES)) THEN
                  DO solver_matrix_idx=1,SOLVER_MAPPING%NUMBER_OF_SOLVER_MATRICES
                    SOLVER_MATRIX=>SOLVER_MATRICES%MATRICES(solver_matrix_idx)%PTR
                ...
                ELSE
                  CALL FLAG_ERROR("Solver Matrices is not associated.",ERR,ERROR,*999)
                ENDIF
                ! Check for analytic values to update (e.g. boundary conditions)
                equationsSet=>solverMapping%EQUATIONS_SETS(1)%PTR
                IF(ASSOCIATED(equationsSet)) THEN
                  IF(ASSOCIATED(equationsSet%ANALYTIC)) THEN
                    ! Update analytic time value with current time
                ...
                ENDIF
              CASE DEFAULT
                LOCAL_ERROR="Solver number "//TRIM(NUMBER_TO_VSTRING(SOLVER_EQUATIONS%SOLVER%GLOBAL_NUMBER,"*",ERR,ERROR))// &
                  & " is not valid for a the 1D subloop in a 3D-1D coupled fluid problem."
                CALL FLAG_ERROR(LOCAL_ERROR,ERR,ERROR,*999)
              END SELECT
            CASE DEFAULT
              LOCAL_ERROR="Subloop "//TRIM(NUMBER_TO_VSTRING(CONTROL_LOOP%SUB_LOOP_INDEX,"*",ERR,ERROR))// &
                & " is not valid for a 3D-1D fluid problem."
              CALL FLAG_ERROR(LOCAL_ERROR,ERR,ERROR,*999)
            END SELECT
  ...
  SUBROUTINE NAVIER_STOKES_PROBLEM_SUBTYPE_SET(PROBLEM,PROBLEM_SUBTYPE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(PROBLEM)) THEN
      ...
      CASE(PROBLEM_Constitutive_NAVIER_STOKES_SUBTYPE)
        PROBLEM%CLASS=PROBLEM_FLUID_MECHANICS_CLASS
        PROBLEM%TYPE=PROBLEM_NAVIER_STOKES_EQUATION_TYPE
        PROBLEM%SUBTYPE=PROBLEM_Constitutive_NAVIER_STOKES_SUBTYPE
      CASE(PROBLEM_QUASISTATIC_NAVIER_STOKES_SUBTYPE)
        PROBLEM%CLASS=PROBLEM_FLUID_MECHANICS_CLASS
        PROBLEM%TYPE=PROBLEM_NAVIER_STOKES_EQUATION_TYPE
      ...
      CASE(PROBLEM_Coupled3D1D_NAVIER_STOKES_SUBTYPE)
        PROBLEM%CLASS=PROBLEM_FLUID_MECHANICS_CLASS
        PROBLEM%TYPE=PROBLEM_NAVIER_STOKES_EQUATION_TYPE
        PROBLEM%SUBTYPE=PROBLEM_Coupled3D1D_NAVIER_STOKES_SUBTYPE
...
!
  ...
  SUBROUTINE NAVIER_STOKES_PROBLEM_SETUP(PROBLEM,PROBLEM_SETUP,ERR,ERROR,*)
    ...
    TYPE(CONTROL_LOOP_TYPE), POINTER :: subLoop3D,subLoop1D
    TYPE(SOLVER_TYPE), POINTER :: SOLVER, MESH_SOLVER,BIF_SOLVER
    TYPE(SOLVER_TYPE), POINTER :: solverNavierStokes3D,solverNavierStokes1D,solverCharacteristic
    TYPE(SOLVER_TYPE), POINTER :: CELLML_SOLVER
    TYPE(SOLVER_EQUATIONS_TYPE), POINTER :: SOLVER_EQUATIONS,MESH_SOLVER_EQUATIONS,BIF_SOLVER_EQUATIONS
    TYPE(SOLVER_EQUATIONS_TYPE), POINTER :: solverEquations3D,solverEquations1D,solverEquationsCharacteristic
    TYPE(SOLVERS_TYPE), POINTER :: SOLVERS
    TYPE(SOLVERS_TYPE), POINTER :: solvers3D,solvers1D
    ...
    NULLIFY(subLoop1D)
    NULLIFY(SOLVER)
    NULLIFY(solverNavierStokes3D)
    NULLIFY(solverNavierStokes1D)
    NULLIFY(solverCharacteristic)
    NULLIFY(MESH_SOLVER)
    ...
    NULLIFY(solverEquationsCharacteristic)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      IF(ASSOCIATED(EQUATIONS)) THEN
        ...
        CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_LAPLACE_NAVIER_STOKES_SUBTYPE, &
          ...
          SELECT CASE(EQUATIONS_SET%SUBTYPE)
            ...
            CASE(EQUATIONS_SET_TRANSIENT_SUPG_NAVIER_STOKES_SUBTYPE)
              ...
              IF(UPDATE_NONLINEAR_RESIDUAL) THEN
                ...
                ENDIF
              END IF
            CASE(EQUATIONS_SET_TRANSIENT_SUPG_NAVIER_STOKES_MULTIDOMAIN_SUBTYPE,EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE)
              DECOMPOSITION => DEPENDENT_FIELD%DECOMPOSITION
              MESH_COMPONENT_NUMBER = DECOMPOSITION%MESH_COMPONENT_NUMBER
              global_element_idx = DECOMPOSITION%DOMAIN(MESH_COMPONENT_NUMBER)%PTR%MAPPINGS%ELEMENTS% &
                & LOCAL_TO_GLOBAL_MAP(ELEMENT_NUMBER)
          ...
          IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE) THEN
            ! Gauss-based viscosity, constant density
...
999 CALL ERRORS("NAVIER_STOKES_FINITE_ELEMENT_RESIDUAL_EVALUATE",ERR,ERROR)
  ...
  SUBROUTINE NAVIER_STOKES_FINITE_ELEMENT_JACOBIAN_EVALUATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    INTEGER(INTG) :: userElementNumber
...
!               SOURCE_VECTOR=>EQUATIONS_MATRICES%SOURCE_VECTOR
              ...
              CASE(EQUATIONS_SET_TRANSIENT_SUPG_NAVIER_STOKES_MULTIDOMAIN_SUBTYPE, &
                ...
                global_element_idx = DECOMPOSITION%DOMAIN(MESH_COMPONENT_NUMBER)%PTR%MAPPINGS%ELEMENTS% &
                  & LOCAL_TO_GLOBAL_MAP(ELEMENT_NUMBER)
                userElementNumber = global_element_idx
                MESH_ELEMENT => DECOMPOSITION%MESH%TOPOLOGY(MESH_COMPONENT_NUMBER)%PTR%ELEMENTS%ELEMENTS(global_element_idx)
                NONLINEAR_MAPPING=>EQUATIONS_MAPPING%NONLINEAR_MAPPING
                NONLINEAR_MATRICES=>EQUATIONS_MATRICES%NONLINEAR_MATRICES
                JACOBIAN_MATRIX=>NONLINEAR_MATRICES%JACOBIANS(1)%PTR
...
999 CALL ERRORS("NAVIER_STOKES_FINITE_ELEMENT_JACOBIAN_EVALUATE",ERR,ERROR)
  ...
  SUBROUTINE NAVIER_STOKES_POST_SOLVE(CONTROL_LOOP,SOLVER,ERR,ERROR,*)
    ...
    TYPE(VARYING_STRING) :: LOCAL_ERROR
    INTEGER(INTG) :: currentLoopIteration,outputIteration
    CHARACTER(14) :: outputFilename
            ...
            IF(ASSOCIATED(equationsSet)) THEN
              IF(ASSOCIATED(equationsSet%ANALYTIC)) THEN
                ...
                ELSE
                  ...
                  outputIteration=CONTROL_LOOP%TIME_LOOP%OUTPUT_NUMBER
                  IF(outputIteration/=0) THEN
                    CALL WRITE_STRING(GENERAL_OUTPUT_TYPE,"Now export analytic analysis... ",ERR,ERROR,*999)
                    IF(CONTROL_LOOP%TIME_LOOP%CURRENT_TIME<=CONTROL_LOOP%TIME_LOOP%STOP_TIME) THEN
                      IF(currentLoopIteration<10) THEN
                        WRITE(outputFilename,'("Analytic_000",I0)') currentLoopIteration
                      ELSE IF(currentLoopIteration<100) THEN
                        WRITE(outputFilename,'("Analytic_00",I0)') currentLoopIteration
                      ELSE IF(currentLoopIteration<1000) THEN
                        WRITE(outputFilename,'("Analytic_0",I0)') currentLoopIteration
                      ELSE IF(currentLoopIteration<10000) THEN
                        WRITE(outputFilename,'("Analytic_",I0)') currentLoopIteration
                      END IF
                      CALL ANALYTIC_ANALYSIS_OUTPUT(equationsSet%DEPENDENT%DEPENDENT_FIELD,outputFilename,ERR,ERROR,*999)
                    ENDIF
                  ENDIF
                ENDIF
              ENDIF
                              ...
                              IF(ASSOCIATED(FIELD_VARIABLE)) THEN
                                ...
                                DO component_idx=1,FIELD_VARIABLE%NUMBER_OF_COMPONENTS
                                  IF(FIELD_VARIABLE%COMPONENTS(component_idx)%INTERPOLATION_TYPE== & 
                                    & FIELD_NODE_BASED_INTERPOLATION .OR. EQUATIONS_SET%ANALYTIC%ANALYTIC_FUNCTION_TYPE== &
                                    & EQUATIONS_SET_NAVIER_STOKES_EQUATION_PowerLaw) THEN
...
999 CALL ERRORS("NAVIER_STOKES_POST_SOLVE_OUTPUT_DATA",ERR,ERROR)
  ...
  SUBROUTINE NavierStokes_AnalyticCalculate(equationsSet,boundaryConditions,err,error,*)
    ...
    INTEGER(INTG) :: boundaryConditionsCheckVariable
      ...
      DO variableIdx=1,dependentField%NUMBER_OF_VARIABLES
        ...
        IF(ASSOCIATED(fieldVariable)) THEN
          ...
          DO componentIdx=1,fieldVariable%NUMBER_OF_COMPONENTS
            boundaryCount=0
            IF(fieldVariable%COMPONENTS(componentIdx)%INTERPOLATION_TYPE==FIELD_NODE_BASED_INTERPOLATION .OR. &
              & equationsSet%ANALYTIC%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_NAVIER_STOKES_EQUATION_PowerLaw) THEN
                    ...
                    DO nodeIdx=1,domainNodes%NUMBER_OF_NODES
                      ...
                      CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_PowerLaw, &
                        ...
                        IF(variableIdx < 3) THEN
                          ...
                          ENDDO !dimensionIdx
                          ! Set analytic pressure value (component 4 of analytic parameters)
                          ! versionIdx=1
                          ! derivativeIdx=1
                          ! CALL FIELD_PARAMETER_SET_GET_NODE(analyticField,FIELD_U_VARIABLE_TYPE, &
                          !   & FIELD_VALUES_SET_TYPE,versionIdx,derivativeIdx,nodeIdx,componentIdx, &
                          !   & W(componentIdx,versionIdx),err,error,*999)
                          !Loop over the derivatives
                          DO derivativeIdx=1,domainNodes%NODES(nodeIdx)%NUMBER_OF_DERIVATIVES
                            ...
                            DO versionIdx=1,domainNodes%NODES(nodeIdx)%DERIVATIVES(derivativeIdx)%NUMBER_OF_VERSIONS
                              ...
                              CALL FIELD_PARAMETER_SET_UPDATE_LOCAL_DOF(dependentField,variableType, &
                                & FIELD_ANALYTIC_VALUES_SET_TYPE,local_ny,VALUE,err,error,*999)
                              ! IF(analyticFunctionType==EQUATIONS_SET_NAVIER_STOKES_EQUATION_PowerLaw.AND.TIME<ZERO_TOLERANCE) THEN
                              !   IF(variableType==FIELD_U_VARIABLE_TYPE) THEN
                              !     IF(domainNodes%NODES(nodeIdx)%BOUNDARY_NODE) THEN
                              !       !Do nothing for boundary nodes
                              !     ELSE
                              !       !Set the initial condition for free nodes
                              !       CALL FIELD_PARAMETER_SET_UPDATE_LOCAL_DOF(dependentField,variableType, &
                      ...
                      ! --- Set boundary conditions with analytic value ---
                      CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_WAVEFORM1, &
...
!\todo: Introduce user-defined or default values instead for density and viscosity
    ...
    CURRENT_TIME=TIME
     ...
     CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_PowerLaw)
       !For fully developed 2D laminar flow of a power law fluid in a pipe, velocity shape profile:
       !u(r) = (n/(n+1))*((dP/dL)*(1/(2K)))^(1/n)*(R^((n+1)/n)-r^((n+1)/n))
       IF(NUMBER_OF_DIMENSIONS==3.AND.NUMBER_OF_COMPONENTS==4) THEN
         SELECT CASE(VARIABLE_TYPE)
         CASE(FIELD_U_VARIABLE_TYPE)
           n = ANALYTIC_PARAMETERS(1) ! n : the power index for the given power-law model
           K = ANALYTIC_PARAMETERS(2) ! K : consistency index, coefficient of problem
           R = ANALYTIC_PARAMETERS(3) ! R : outer radius of pipe
           dPdX = ANALYTIC_PARAMETERS(4) ! P : pressure gradient
           position = SQRT(X(1)**2.0_DP + X(2)**2.0_DP) ! radial position of current node
           length = X(3) ! axial position of current node
           SELECT CASE(GLOBAL_DERIV_INDEX)
           CASE(NO_GLOBAL_DERIV)
             !Initialise velocity to parabolic (poiseuille) field if t==0
             IF(TIME<ZERO_TOLERANCE) THEN
               ...
               ELSE IF(componentNumber==3) THEN
                 !w
                 VALUE=0.25_DP*dPdX*(R**2.0_DP - position**2.0_DP)
               ELSE IF(componentNumber==4) THEN
                 VALUE=(10.0_DP-length)*dPdX
               ENDIF
             ELSE IF(componentNumber==1) THEN
!             IF(componentNumber==1) THEN
               !calculate u
               VALUE=0.0_DP
             ELSE IF(componentNumber==2) THEN
             ...
             ELSE IF(componentNumber==3) THEN
               !calculate w
               VALUE=(n/(n+1.0_DP))*(((dPdX)/(2.0_DP*K))**(1.0_DP/n))*(R**((n+1)/n) - position**((n+1)/n))
             ELSE IF(componentNumber==4) THEN
               VALUE=(10.0_DP-length)*dPdX
             ELSE
               CALL FLAG_ERROR("should be 4 components for 3D a power law analytic fluid example.",ERR,ERROR,*999)
             ENDIF
           CASE(GLOBAL_DERIV_S1)
             CALL FLAG_ERROR("Not implemented.",ERR,ERROR,*999)
           CASE(GLOBAL_DERIV_S2)
         ...
         CASE(FIELD_U_VARIABLE_TYPE)
           ...
           CASE(NO_GLOBAL_DERIV)
             IF(componentNumber==1) THEN
               ...
               VALUE=21.76_DP*(0.326_DP + &
                     &     0.14_DP*cos(2*pi*(CURRENT_TIME/(period))) &
                     &    -0.77_DP*cos(4*pi*(CURRENT_TIME/(period))) &
                     &     +0.2_DP*cos(6*pi*(CURRENT_TIME/(period))) &
                     &   +0.125_DP*cos(8*pi*(CURRENT_TIME/(period))) &
                     &  +0.063_DP*cos(10*pi*(CURRENT_TIME/(period))) &
                     ...
                     &    +0.0_DP*sin(20*pi*(CURRENT_TIME/(period))))/10.0_DP
             ELSE
               CALL FLAG_ERROR("Incorrect component specification for waveform 1",ERR,ERROR,*999)
             ENDIF
           CASE DEFAULT
             LOCAL_ERROR="The global derivative index of "//TRIM(NUMBER_TO_VSTRING( &
...
999 CALL ERRORS("NAVIER_STOKES_ANALYTIC_FUNCTIONS_EVALUATE",ERR,ERROR)
  ...
  SUBROUTINE NavierStokes_SUPGCalculate(equationsSet,elementNumber,tauSUPG,err,error,*)
    ...
    TYPE(DOMAIN_MAPPING_TYPE), POINTER :: nodeMapping
    ...
    INTEGER(INTG) :: nodeNumber,numberOfDimensions,local_ny,userElementNumber,decompositionLocalElementNumber
    INTEGER(INTG) :: globalNodeNumber,localNodeNumber,computationalNode,variableType
    REAL(DP) :: muParameter,rhoParameter,alphaParameter,lengthScale,reynoldsNumber,pecletNumber
    REAL(DP) :: sumMuParameter
    REAL(DP) :: magnitudeVelocitySUPG,maxVelocitySUPG,lineLength
    REAL(DP) :: X1(3),X2(3),velocityGauss(3),velocityGaussSUPG(3)
    TYPE(VARYING_STRING) :: localError
    LOGICAL :: nodeExists,userElementExists,ghostElement
    ...
    IF(ASSOCIATED(equationsSet))THEN
      ...
      CASE(EQUATIONS_SET_TRANSIENT_SUPG_NAVIER_STOKES_SUBTYPE, &
        ...
        IF(ASSOCIATED(equations)) THEN
          ...
          userElementNumber = dependentField%DECOMPOSITION%DOMAIN(1)%PTR%MAPPINGS%ELEMENTS%LOCAL_TO_GLOBAL_MAP(elementNumber)
            ...
            IF(ASSOCIATED(equationsSetField)) THEN
              ...
              IF(userElementExists .AND. .NOT. ghostElement ) THEN
                ...
                CALL FIELD_PARAMETER_SET_GET_ELEMENT(equationsSetField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                 & userElementNumber,1,lengthScale,err,error,*999)                
                ...
                IF(ABS(lengthScale)<=ZERO_TOLERANCE) THEN
                  ...
                  nodeMapping=>geometricField%DECOMPOSITION%DOMAIN(1)%PTR%MAPPINGS%NODES
  ...
  !                  & PTR%ELEMENTS%ELEMENTS(elementNumber)%BASIS%NUMBER_OF_ELEMENT_PARAMETERS
                    ...
                    ! gives local node number
                    localNodeNumber=geometricField%DECOMPOSITION%DOMAIN(geometricField%DECOMPOSITION%MESH_COMPONENT_NUMBER)%PTR% &
                     & TOPOLOGY%ELEMENTS%ELEMENTS(elementNumber)%ELEMENT_NODES(elementNodeIdx)

  !                  CALL DOMAIN_MAPPINGS_GLOBAL_TO_LOCAL_GET(nodeMapping,globalNodeNumber,nodeExists,localNodeNumber,ERR,ERROR,*999)
                    variableType=geometricField%VARIABLES(1)%VARIABLE_TYPE
                    fieldVariable=>geometricField%VARIABLE_TYPE_MAP(variableType)%PTR
                    ...
                    IF(ASSOCIATED(domain)) THEN
                      IF(ASSOCIATED(domain%TOPOLOGY)) THEN
                        domainNodes=>domain%TOPOLOGY%NODES
                        !Loop over the derivatives
                        DO derivativeIdx=1,domainNodes%NODES(localNodeNumber)%NUMBER_OF_DERIVATIVES
                          !Loop over versions
                          DO versionIdx=1,domainNodes%NODES(localNodeNumber)%DERIVATIVES(derivativeIdx)%NUMBER_OF_VERSIONS
                            !Loop over dimensions
                            DO dimensionIdx=1,numberOfDimensions
                              local_ny=fieldVariable%COMPONENTS(dimensionIdx)%PARAM_TO_DOF_MAP% &
                                & NODE_PARAM2DOF_MAP%NODES(localNodeNumber)%DERIVATIVES(derivativeIdx)%VERSIONS(versionIdx)
                              IF(local_ny > SIZE(geometricParameters)) THEN
                                CALL FLAG_ERROR("local_ny out of bounds.",err,error,*999)                              
                              ENDIF
                  ...
                  CALL FIELD_PARAMETER_SET_ADD_ELEMENT(equationsSetField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                    & userElementNumber,1,lengthScale,err,error,*999)
                  CALL FIELD_PARAMETER_SET_ADD_ELEMENT(equationsSetField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                    & userElementNumber,2,0.0_DP,err,error,*999)
                  CALL FIELD_PARAMETER_SET_ADD_ELEMENT(equationsSetField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                    & userElementNumber,3,0.0_DP,err,error,*999)
                  CALL FIELD_PARAMETER_SET_ADD_ELEMENT(equationsSetField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                    & userElementNumber,4,0.0_DP,err,error,*999)
  ...
  !                & MATERIALS_INTERP_PARAMETERS(FIELD_U_VARIABLE_TYPE)%PTR,err,error,*999)
                ...
                DO gaussIdx=1,quadratureScheme%NUMBER_OF_GAUSS
                  ...
                  IF(equationsSet%SUBTYPE==EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE) THEN
                    IF(ASSOCIATED(materialsField)) THEN
                      CALL FIELD_PARAMETER_SET_GET_GAUSS_POINT(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                       & userElementNumber,gaussIdx,1,muParameter,err,error,*999)
                      ! scale to cm
                      muParameter=muParameter/100.0_DP
                    ELSE
                      CALL FLAG_ERROR("Materials field is not associated.",err,error,*999)                    
                    ENDIF
                    sumMuParameter=sumMuParameter+muParameter
                  ENDIF
                END DO !gaussIdx

                !Materials parameters
                IF(equationsSet%SUBTYPE==EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE) THEN
                  ! use average element viscosity value?
                  muParameter=sumMuParameter/quadratureScheme%NUMBER_OF_GAUSS
                  CALL FIELD_PARAMETER_SET_GET_CONSTANT(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,2, &
                   & rhoParameter,err,error,*999)
                ELSE
                  CALL FIELD_PARAMETER_SET_GET_CONSTANT(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,1, &
                   & muParameter,err,error,*999)
                  CALL FIELD_PARAMETER_SET_GET_CONSTANT(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,2, &
                   & rhoParameter,err,error,*999)
                ...
                CALL FIELD_PARAMETER_SET_UPDATE_ELEMENT(equationsSetField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                 & userElementNumber,2,maxVelocitySUPG,err,error,*999)
                ...
                CALL FIELD_PARAMETER_SET_UPDATE_ELEMENT(equationsSetField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                  & userElementNumber,3,reynoldsNumber,err,error,*999)
                ...
                ELSE
                  tauSUPG=0.0_DP
                ENDIF
              ENDIF ! check computational node
            ELSE
              CALL FLAG_ERROR("Equations set field field is not associated.",err,error,*999)
            ENDIF               
          ELSE
...
999 CALL ERRORS("NavierStokes_SUPGCalculate",err,error)
  ...
  SUBROUTINE NavierStokes_FiniteElementFaceIntegrate(equationsSet,elementNumber,dependentVariable,err,error,*)
    ...
    TYPE(FIELD_INTERPOLATED_POINT_TYPE), POINTER :: faceInterpolatedPoint
    TYPE(FIELD_INTERPOLATION_PARAMETERS_TYPE), POINTER :: dependentInterpolationParameters
    TYPE(FIELD_INTERPOLATION_PARAMETERS_TYPE), POINTER :: facePressureInterpolationParameters
    ...
    INTEGER(INTG) :: elementBaseDof1,elementBaseDof2
    ...
    INTEGER(INTG) :: rhsVariableType,var2,decompositionLocalElementNumber,userElementNumber
    ...
    REAL(DP) :: stress
    LOGICAL :: elementIsMultidomainBoundary,invertedNormal,original,correctFace
    ...
    NULLIFY(faceInterpolatedPoint)
    NULLIFY(dependentInterpolationParameters)
    NULLIFY(facePressureInterpolationParameters)
    ...
    CASE(EQUATIONS_SET_TRANSIENT_SUPG_NAVIER_STOKES_MULTIDOMAIN_SUBTYPE, &
      ...
      IF(ASSOCIATED(equationsEquationsSetField)) THEN
        equationsSetField=>equationsEquationsSetField%EQUATIONS_SET_FIELD_FIELD
        IF(ASSOCIATED(equationsSetField)) THEN
          ! Check element exists on this process
          userElementExists=.FALSE.
          ghostElement=.TRUE.
      ...
      IF(elementIsMultidomainBoundary .AND. boundaryID > 1) THEN
        ...
        materialsField=>equationsSet%MATERIALS%MATERIALS_FIELD
        IF(equationsSet%SUBTYPE==EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE) THEN
          ! use gauss point based mu value
        ELSE
          CALL FIELD_PARAMETER_SET_GET_CONSTANT(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,1, &
           & mu,err,error,*999)
        ENDIF
...
!          geometricInterpolatedPoint=>equations%INTERPOLATION%GEOMETRIC_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR
          ...
          rhsVariableType=equations%EQUATIONS_MAPPING%RHS_MAPPING%RHS_VARIABLE_TYPE
...
!              IF (normalComponentIdx/=3) CYCLE
            ...
            ! var2=equations%EQUATIONS_MAPPING%RHS_MAPPING%RHS_VARIABLE%VARIABLE_NUMBER 
            ! facePressureInterpolationParameters=>equations%INTERPOLATION%DEPENDENT_INTERP_PARAMETERS(rhsVariableType)%PTR
            ! CALL FIELD_INTERPOLATION_PARAMETERS_FACE_GET(FIELD_PRESSURE_VALUES_SET_TYPE,faceNumber, &
            !   & facePressureInterpolationParameters,ERR,ERROR,*999)
            ! faceInterpolatedPoint=>equations%INTERPOLATION%DEPENDENT_INTERP_POINT(var2)%PTR

            DO gaussIdx=1,faceQuadratureScheme1%NUMBER_OF_GAUSS

              !Constituitive gauss based viscosity
              IF(equationsSet%SUBTYPE==EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE) THEN
                CALL FIELD_PARAMETER_SET_GET_GAUSS_POINT(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                  & userElementNumber,gaussIdx,1,mu,err,error,*999)
                mu=mu/100.0_DP
              ENDIF

              ! CALL FIELD_INTERPOLATE_GAUSS(NO_PART_DERIV,BASIS_DEFAULT_QUADRATURE_SCHEME,gaussIdx, &
              !   & faceInterpolatedPoint,err,error,*999)
              ! pressureGauss=faceInterpolatedPoint%VALUES(normalComponentIdx,4)    !Surface pressure at this gauss point
...
!              CALL MATRIX_PRODUCT(dUdXi,dXidX,dUdX,ERR,ERROR,*999) !dU/dX = dU/dxi * dxi/dX (deformation gradient tensor)
              ...
              ! DZDXI=dependentInterpolatedPoint%VALUES(1:3,PARTIAL_DERIVATIVE_FIRST_DERIVATIVE_MAP(1:3)) !(component,derivative)
...
!                  normalProjection=DOT_PRODUCT(GIJU(normalComponentIdx,:),DZDXI(componentIdx,:))
                  ...
                  DO xiIdx=1,dependentBasis1%NUMBER_OF_XI
                    DO xi2Idx=1,dependentBasis1%NUMBER_OF_XI
                      sumDelU=sumDelU + delUGauss(componentIdx,xiIdx)*pointMetrics%dXi_dX(xiIdx,xi2Idx)
                    ENDDO
                  ENDDO !xiIdx

                  stress = mu*sumDelU - pressureGauss
                  !  B a s i s  1  -  V e l o c i t y
                  elementBaseDof1=dependentBasis1%NUMBER_OF_ELEMENT_PARAMETERS*(componentIdx-1)
                  DO faceNodeIdx=1,faceBasis1%NUMBER_OF_NODES
                    ...
                    DO faceNodeDerivativeIdx=1,faceBasis1%NUMBER_OF_DERIVATIVES(faceNodeIdx)
                      ...
                      elementDofIdx=elementBaseDof1+parameterIdx
  !                    IF(boundaryID > 1) THEN
                      ...
                      nonlinearMatrices%ELEMENT_RESIDUAL%VECTOR(elementDofIdx) = &
                        & nonlinearMatrices%ELEMENT_RESIDUAL%VECTOR(elementDofIdx) + &
                        &  pressureGauss*normalProjection* &
                        &  faceQuadratureScheme1%GAUSS_BASIS_FNS(faceParameterIdx,NO_PART_DERIV,gaussIdx)* &
                        &  faceQuadratureScheme1%GAUSS_WEIGHTS(gaussIdx)*volumeJacobian

                      ! rhsVector%ELEMENT_VECTOR%VECTOR(elementDofIdx) = rhsVector%ELEMENT_VECTOR%VECTOR(elementDofIdx) + &
                      !   &  (mu*sumDelU - pressureGauss)*unitNormal(componentIdx)* &
                      !   &  faceQuadratureScheme1%GAUSS_BASIS_FNS(faceParameterIdx,NO_PART_DERIV,gaussIdx)* &
                      !   &  faceQuadratureScheme1%GAUSS_WEIGHTS(gaussIdx)*areaJacobian
...
999 CALL ERRORS("NavierStokes_FiniteElementFaceIntegrate",err,error)
  ...
  SUBROUTINE NavierStokes_CalculateBoundaryFlux(controlLoop,solver,err,error,*)
    ...
    REAL(DP) :: totalShearRate,averageShearRate,shearRate
    REAL(DP) :: faceVector1(3),faceVector2(3),X1(3),X2(3),lineLength,lineLength1,lineLength2,phiParameter
    ...
    boundaryFlux=0.0_DP
    faceFlux=0.0_DP
    totalShearRate=0.0_DP
    shearRate=0.0_DP
    averageShearRate=0.0_DP
    numberOfFaceElements = 0
    numberOfElementGauss = 0
...
!                    CALL FIELD_INTERPOLATED_POINT_METRICS_CALCULATE(COORDINATE_JACOBIAN_AREA_TYPE,pointMetrics,err,error,*999)
                ...
                IF (correctFace) THEN
                  ...
                  DO componentIdx=1,dependentVariable%NUMBER_OF_COMPONENTS-1
                    ...
                    IF(ABS(normalProjection)<(ZERO_TOLERANCE*10.0_DP)) CYCLE
...
!      sumFaceFlux=sumFaceFlux + boundaryFlux(2)
      ...
      DO boundaryIdx=1,SIZE(boundaryFlux)
        IF(ABS(boundaryArea(boundaryIdx)) > ZERO_TOLERANCE) THEN
          CALL WRITE_STRING_VALUE(DIAGNOSTIC_OUTPUT_TYPE,"Boundary: ",boundaryIdx,err,error,*999)
          CALL WRITE_STRING_VALUE(DIAGNOSTIC_OUTPUT_TYPE,"   Area: ",boundaryArea(boundaryIdx),err,error,*999)
          CALL WRITE_STRING_VALUE(DIAGNOSTIC_OUTPUT_TYPE,"   Flux: ",boundaryFlux(boundaryIdx),err,error,*999)
        ENDIF
      ENDDO
...
999 CALL ERRORS("NavierStokes_Couple1D0D",err,error)
  ...
  !================================================================================================================================
  !
  !> Update the characteristic values for branches and coupling in a Navier-Stokes/Characteristic solver
  SUBROUTINE NavierStokes_UpdateCharacteristics(solverEquations,timeIncrement,err,error,*)

    !Argument Variables
    TYPE(SOLVER_EQUATIONS_TYPE), POINTER :: solverEquations  !<A pointer to the solver equations for the Characteristic equations
    REAL(DP), INTENT(IN) :: timeIncrement !< time increment value from time control loop
    INTEGER(INTG), INTENT(OUT) :: err !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: error !<The error string
    ...
    INTEGER(INTG) :: variableType,localDof,boundaryConditionCheckVariable
    INTEGER(INTG) :: nodeIdx,derivativeIdx,componentIdx,versionIdx,elementIdx,elementNodeIdx,materialIdx,parameterIdx
    INTEGER(INTG) :: elementNumber,elementNodeNumber,elementNodeVersion,versionElementNumber(3)
    INTEGER(INTG) :: numberOfNodes,numberOfVersions
    REAL(DP) :: normalWave(2,3),xi(1),extrapQ(3),extrapA(3),W(2,3)
    REAL(DP) :: areaCalculated,flowCalculated,As,Bn,Bs,lEigenvalue,Fr,Kr,density,A0(3),Beta(3)
    LOGICAL :: inletNode,outletNode,fixedNode,nonReflecting

    CALL ENTERS("NavierStokes_UpdateCharacteristics",ERR,ERROR,*999)
    ...
    IF(ASSOCIATED(solverEquations)) THEN
      ...
      IF(ASSOCIATED(solverMapping)) THEN
        ...
        IF(ASSOCIATED(equations)) THEN
          ...
          numberOfNodes=dependentField%DECOMPOSITION%DOMAIN(1)%PTR%TOPOLOGY%NODES%TOTAL_NUMBER_OF_NODES
          !!!--  L o o p   O v e r   N o d e s  --!!!
          DO nodeIdx=1,numberOfNodes
            ...
            DO componentIdx=1,2
              DO versionIdx=1,numberOfVersions
                localDof=fieldVariable%COMPONENTS(componentIdx)%PARAM_TO_DOF_MAP% &
                 & NODE_PARAM2DOF_MAP%NODES(nodeIdx)%DERIVATIVES(derivativeIdx)%VERSIONS(versionIdx)
                normalWave(componentIdx,versionIdx)=independentParameters(localDof)
              ENDDO
            ENDDO
            ...
            IF (ABS(normalWave(1,1))> ZERO_TOLERANCE .OR. ABS(normalWave(2,1)) > ZERO_TOLERANCE) THEN
                    ...
                    IF(elementNodeNumber==nodeIdx) THEN
                      ...
                      DO versionIdx=1,numberOfVersions
                        ...
                        IF(elementNodeVersion==versionIdx) THEN
                          ...
                          versionElementNumber(versionIdx)=elementNumber
                          materialIdx=9
                          CALL FIELD_PARAMETER_SET_GET_ELEMENT(materialsField,FIELD_U_VARIABLE_TYPE, &
                           & FIELD_VALUES_SET_TYPE,elementNumber,materialIdx,A0(versionIdx),err,error,*999)                
                          materialIdx=10
                          CALL FIELD_PARAMETER_SET_GET_ELEMENT(materialsField,FIELD_U_VARIABLE_TYPE, &
                           & FIELD_VALUES_SET_TYPE,elementNumber,materialIdx,Beta(versionIdx),err,error,*999)                
                        ENDIF
                ...
                DO componentIdx=1,2
                  DO versionIdx=1,numberOfVersions                       
                    IF(ABS(normalWave(componentIdx,versionIdx))> ZERO_TOLERANCE) THEN
                      ...
                      CALL FIELD_INTERPOLATE_XI(NO_PART_DERIV,xi,equations%INTERPOLATION% &
                        & DEPENDENT_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR,ERR,ERROR,*999)
                      extrapQ(versionIdx)=equations%INTERPOLATION%DEPENDENT_INTERP_POINT(FIELD_U_VARIABLE_TYPE)% &
                        & PTR%VALUES(1,NO_PART_DERIV)
                      extrapA(versionIdx)=equations%INTERPOLATION%DEPENDENT_INTERP_POINT(FIELD_U_VARIABLE_TYPE)% &
                        & PTR%VALUES(2,NO_PART_DERIV)
                    ENDIF
                  ENDDO ! versionIdx
                ENDDO !componentIdx
              ...
              ELSE
                ...
                IF(ASSOCIATED(boundaryConditions)) THEN
                  ...
                  IF(ASSOCIATED(boundaryConditionsVariable)) THEN
                    ...
                    parameterIdx=2
                    versionIdx=1
                    localDof=fieldVariable%COMPONENTS(parameterIdx)%PARAM_TO_DOF_MAP% &
                     & NODE_PARAM2DOF_MAP%NODES(nodeIdx)%DERIVATIVES(derivativeIdx)%VERSIONS(versionIdx)
                    boundaryConditionCheckVariable=boundaryConditionsVariable% &
                     & CONDITION_TYPES(localDof)
                    IF(boundaryConditionCheckVariable==BOUNDARY_CONDITION_FIXED_INLET) THEN
                      inletNode=.TRUE.
                    ELSE IF(boundaryConditionCheckVariable==BOUNDARY_CONDITION_FIXED_OUTLET) THEN
                      outletNode=.TRUE.
                ...
                materialIdx=9
                CALL FIELD_PARAMETER_SET_GET_ELEMENT(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                 & elementNumber,materialIdx,A0(versionIdx),err,error,*999)                
                materialIdx=10
                CALL FIELD_PARAMETER_SET_GET_ELEMENT(materialsField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                 & elementNumber,materialIdx,Beta(versionIdx),err,error,*999)                
                ...
                CALL FIELD_PARAMETER_SET_GET_NODE(dependentField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                 & versionIdx,derivativeIdx,nodeIdx,parameterIdx,extrapQ(versionIdx),err,error,*999)
                parameterIdx=2
                CALL FIELD_PARAMETER_SET_GET_NODE(dependentField,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                 & versionIdx,derivativeIdx,nodeIdx,parameterIdx,extrapA(versionIdx),err,error,*999)
              ...
              localDof=fieldVariable%COMPONENTS(2)%PARAM_TO_DOF_MAP%CONSTANT_PARAM2DOF_MAP
              density=materialsParameters(localDof)
              localDof=fieldVariable%COMPONENTS(3)%PARAM_TO_DOF_MAP%CONSTANT_PARAM2DOF_MAP
              Kr=materialsParameters(localDof)
              localDof=fieldVariable%COMPONENTS(4)%PARAM_TO_DOF_MAP%CONSTANT_PARAM2DOF_MAP
              Bs=materialsParameters(localDof)
              localDof=fieldVariable%COMPONENTS(5)%PARAM_TO_DOF_MAP%CONSTANT_PARAM2DOF_MAP
              As=materialsParameters(localDof)
              localDof=fieldVariable%COMPONENTS(7)%PARAM_TO_DOF_MAP%CONSTANT_PARAM2DOF_MAP
              Fr=materialsParameters(localDof)
              ...
              DO componentIdx=1,2
                DO versionIdx=1,numberOfVersions
                  localDof=fieldVariable%COMPONENTS(componentIdx)%PARAM_TO_DOF_MAP% &
                   & NODE_PARAM2DOF_MAP%NODES(nodeIdx)%DERIVATIVES(derivativeIdx)%VERSIONS(versionIdx)
                  W(componentIdx,versionIdx)=dependentParameters(localDof)
                ENDDO
              ENDDO
              ...
              DO componentIdx=1,2
                DO versionIdx=1,numberOfVersions
                  IF(ABS(normalWave(componentIdx,versionIdx))>ZERO_TOLERANCE) THEN
                    W(componentIdx,versionIdx)=((extrapQ(versionIdx)/extrapA(versionIdx))+normalWave(componentIdx,versionIdx)* &
                     & 4.0_DP*SQRT((Fr*(Beta(versionIdx)/Bs)))*(extrapA(versionIdx)**(0.25_DP)))
                  ENDIF
                ENDDO
              ENDDO
              ...
              !non-reflecting boundary conditions on outlet boundaries
              IF(outletNode .AND. normalWave(2,1)<ZERO_TOLERANCE .AND. nonReflecting) THEN
                lEigenvalue = normalWave(2,1)*(extrapA(versionIdx)**(0.25_DP)* &
                 & SQRT(Fr*Beta(versionIdx)/(Bs)))/extrapA(versionIdx)
                Bn = -Kr*extrapQ(versionIdx)/extrapA(versionIdx)
                W(2,1)= W(2,1) + timeIncrement*lEigenvalue*Bn
              ENDIF
              ...
              DO componentIdx=1,2
                DO versionIdx=1,numberOfVersions
                  ...
                  CALL FIELD_PARAMETER_SET_UPDATE_LOCAL_DOF(dependentField,FIELD_V_VARIABLE_TYPE, &
                    & FIELD_VALUES_SET_TYPE,localDof,W(componentIdx,versionIdx),ERR,ERROR,*999)
                ENDDO
              ENDDO
    ...
    CALL EXITS("NavierStokes_UpdateCharacteristics")
    RETURN
999 CALL ERRORS("NavierStokes_UpdateCharacteristics",ERR,ERROR)
    CALL EXITS("NavierStokes_UpdateCharacteristics")
    RETURN 1
  END SUBROUTINE NavierStokes_UpdateCharacteristics
...
!              ENDIF
      ...
      IF(defaultUpdate .EQV. .TRUE.) THEN
        ...
        componentIdx=1
        CALL FIELD_COMPONENT_VALUES_INITIALISE(equationsSetField,FIELD_V_VARIABLE_TYPE, &
         & FIELD_VALUES_SET_TYPE,componentIdx,shearRateDefault,err,error,*999)
      ENDIF
