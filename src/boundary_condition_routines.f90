...
MODULE BOUNDARY_CONDITIONS_ROUTINES
  ...
  INTEGER(INTG), PARAMETER :: MAX_BOUNDARY_CONDITION_NUMBER=28 !The maximum boundary condition type identifier, used for allocating an array with an entry for each type
  ...
  PUBLIC BOUNDARY_CONDITION_FREE,BOUNDARY_CONDITION_FIXED,BOUNDARY_CONDITION_FIXED_INLET,&
    ...
    & BOUNDARY_CONDITION_COUPLING_FLOW,BOUNDARY_CONDITION_COUPLING_STRESS
...
999 CALL ERRORS("BOUNDARY_CONDITIONS_SET_LOCAL_DOFS",ERR,ERROR)
  ...
  SUBROUTINE BoundaryConditions_SetConditionType(boundaryConditionsVariable,globalDof,condition,err,error,*)
    ...
    CASE(BOUNDARY_CONDITION_FIXED_FITTED,BOUNDARY_CONDITION_FIXED_NONREFLECTING,BOUNDARY_CONDITION_FIXED_CELLML, &
      & BOUNDARY_CONDITION_FIXED_STREE,BOUNDARY_CONDITION_COUPLING_FLOW,BOUNDARY_CONDITION_COUPLING_STRESS)
      dofType=BOUNDARY_CONDITION_DOF_FIXED
    CASE DEFAULT
