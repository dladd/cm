...
999 CALL ERRORS("ControlLoop_AbsoluteToleranceSet",err,error)
  ...
  SUBROUTINE ControlLoop_AbsoluteTolerance2Set(controlLoop,absoluteTolerance2,err,error,*)
    ...
    CALL ENTERS("ControlLoop_AbsoluteTolerance2Set",err,error,*999)
    ...
    CALL EXITS("ControlLoop_AbsoluteTolerance2Set")
    RETURN
999 CALL ERRORS("ControlLoop_AbsoluteTolerance2Set",err,error)
    CALL EXITS("ControlLoop_AbsoluteTolerance2Set")
    RETURN 1
  ...
  SUBROUTINE ControlLoop_RelativeToleranceSet(controlLoop,relativeTolerance,err,error,*)
    ...
    CALL ENTERS("ControlLoop_RelativeToleranceSet",err,error,*999)
    ...
    CALL EXITS("ControlLoop_RelativeToleranceSet")
    RETURN
999 CALL ERRORS("ControlLoop_RelativeToleranceSet",err,error)
    CALL EXITS("ControlLoop_RelativeToleranceSet")
    RETURN 1
  ...
  SUBROUTINE CONTROL_LOOP_WHILE_INITIALISE(CONTROL_LOOP,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(CONTROL_LOOP)) THEN
      ...
      ELSE
        ...
        CONTROL_LOOP%WHILE_LOOP%RELATIVE_TOLERANCE=1.0E-5_DP
