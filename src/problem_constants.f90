...
!  INTEGER(INTG), PARAMETER :: PROBLEM_HJ_SUBTYPE=6
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_Coupled3D1D_NAVIER_STOKES_SUBTYPE=12
  INTEGER(INTG), PARAMETER :: PROBLEM_Constitutive_NAVIER_STOKES_SUBTYPE=13
  INTEGER(INTG), PARAMETER :: PROBLEM_Coupled3DDAE_NAVIER_STOKES_SUBTYPE=14
  !  Darcy equation
